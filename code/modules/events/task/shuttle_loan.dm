...
/datum/round_event_control/task/shuttle_loan
	name = "Shuttle Loan"
	...
	Alert()
		...
		switch(dispatch_type)
			if(HIJACK_SYNDIE)
				...
				task_desc = "The syndicate are trying to infiltrate your station. If you let them hijack your shuttle, you'll save us a headache."
			if(RUSKY_PARTY)
				...
				task_desc = "A group of angry russians want to have a party, can you send them your cargo shuttle then make them disappear?"
			if(SPIDER_GIFT)
				...
				task_desc = "The Spider Clan has sent us a mysterious gift, can we ship it to you to see what's inside?"
			if(DEPARTMENT_RESUPPLY)

...
/obj/item/weapon/gun/energy/taser/adv
	name = "hybrid taser"
	desc = "A dual-mode taser designed to fire both high-range high-power electrodes and short-range disabler beams."
	icon_state = "advtaser"
	modifystate = 2
	item_state = null	//so the human update icon uses the icon_state instead.
	ammo_type = list(/obj/item/ammo_casing/energy/taserstun, /obj/item/ammo_casing/energy/taserdisable)
	cell_type = "/obj/item/weapon/stock_parts/cell/crap"

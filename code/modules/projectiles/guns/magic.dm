...
/obj/item/weapon/gun/magic/afterattack(atom/target as mob, mob/living/user as mob, flag)
	...
	if(no_den_usage)
		...
		if(istype(A, /area/wizard_station))
			user << output("<span class='warning'>You know better than to violate the security of The Den, best wait until you leave to use [src].<span>", "ic")
...
/obj/item/weapon/gun/magic/shoot_with_empty_chamber(mob/living/user as mob|obj)
	user << output("<span class='warning'>The [name] whizzles quietly.<span>", "ic")

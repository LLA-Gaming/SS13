...
/mob/living/carbon/alien/beepsky/humanoid/movement_delay()
	. = ..()
	. += move_delay_add + config.alien_delay	//move_delay_add is used to slow aliens with stuns

///mob/living/carbon/alien/beepsky/humanoid/bullet_act(var/obj/item/projectile/Proj) taken care of in living

/mob/living/carbon/alien/beepsky/humanoid/emp_act(severity)
	if(r_store) r_store.emp_act(severity)
	if(l_store) l_store.emp_act(severity)
	..()

/mob/living/carbon/alien/beepsky/humanoid/ex_act(severity)
	..()
...
/mob/living/carbon/alien/beepsky/humanoid/blob_act()
	if (stat == 2)
		return
	var/shielded = 0
	var/damage = null
...
/mob/living/carbon/alien/beepsky/humanoid/attack_paw(mob/living/carbon/monkey/M as mob)
...
/mob/living/carbon/alien/beepsky/humanoid/attack_slime(mob/living/carbon/slime/M as mob)
	if (!ticker)
		M << "You cannot attack people before the game has started."
		return
...
/mob/living/carbon/alien/beepsky/humanoid/attack_animal(mob/living/simple_animal/M as mob)
	//honking angel only
	if (M.quantum_locked)
		return
...
/mob/living/carbon/alien/beepsky/humanoid/attack_hand(mob/living/carbon/human/M as mob)
	if (!ticker)
		M << "You cannot attack people before the game has started."
		return
...
/mob/living/carbon/alien/beepsky/humanoid/attack_alien(mob/living/carbon/alien/beepsky/humanoid/M as mob)
	if (!ticker)
		M << "You cannot attack people before the game has started."
		return
...
/mob/living/carbon/alien/beepsky/humanoid/restrained()
	if (handcuffed)
		return 1
	return 0


/mob/living/carbon/alien/beepsky/humanoid/var/co2overloadtime = null
/mob/living/carbon/alien/beepsky/humanoid/var/temperature_resistance = T0C+75


/mob/living/carbon/alien/beepsky/humanoid/show_inv(mob/user)
...
/mob/living/carbon/alien/beepsky/humanoid/Topic(href, href_list)
	..()
	//strip panel
...
/mob/living/carbon/alien/beepsky/humanoid/canUseTopic(atom/movable/M)

...
/datum/preferences/proc/load_character(slot)
	...
	hair_style			= sanitize_inlist(hair_style, hair_styles_list)
	facial_hair_style			= sanitize_inlist(facial_hair_style, facial_hair_styles_list)
	underwear		= sanitize_inlist(underwear, underwear_all)
	undershirt		= sanitize_inlist(undershirt, undershirt_list)
	...
	if(prefer_dept != "Engineering" && prefer_dept != "Supply" && prefer_dept != "Medical" && prefer_dept != "Science" && prefer_dept != "Brig")

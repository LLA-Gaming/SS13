//DronePort - Devon
// /tg/ provided a fine port on its own, so all I had to do was adapt it to LLA.
// Some /tg/ features have been commented out on the off chance that the functions they were linked to are ever ported over.

/datum/admins/proc/event_panel()
	...
	for(var/datum/event_cycler/C in cyclers)
		...
		dat += "<h3>[C.npc_name] [C.in_rotation ? "" : "<a href='?_src_=holder;event_panel=1;rename_cycler=\ref[C]'>Rename</a>"] [istype(C,/datum/event_cycler/admin_playlist) ? "<a href='?_src_=holder;event_panel=1;remove_cycler=\ref[C]'>X</a>" : ""]</h3>"

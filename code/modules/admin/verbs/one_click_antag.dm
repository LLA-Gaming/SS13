...
/datum/admins/proc/makeTraitors()
	...
	for(var/mob/living/carbon/human/applicant in player_list)
		if(applicant.client.prefs.be_special_gamemode & BE_TRAITOR)
			if(!applicant.stat)
				if(applicant.mind)
...
/datum/admins/proc/makeChanglings()
	...
	for(var/mob/living/carbon/human/applicant in player_list)
		if(applicant.client.prefs.be_special_gamemode & BE_CHANGELING)
			if(!applicant.stat)
				if(applicant.mind)
					if (!applicant.mind.special_role)
...
/datum/admins/proc/makeRevs()
	...
	for(var/mob/living/carbon/human/applicant in player_list)
		if(applicant.client.prefs.be_special_gamemode & BE_REV)
...
/datum/admins/proc/makeCult()
	...
	for(var/mob/living/carbon/human/applicant in player_list)
		if(applicant.client.prefs.be_special_gamemode & BE_CULTIST)
			if(applicant.stat == CONSCIOUS)
				if(applicant.mind)
					if(!applicant.mind.special_role)
...
/datum/admins/proc/makeAliens()
	//new /datum/round_event/alien_infestation{spawncount=3}() //PLEASE RETURN TO THIS AFTER EVENT REWRITE
	return 1

/datum/admins/proc/makeSpaceNinja()
	//new /datum/round_event/ninja() //PLEASE RETURN TO THIS AFTER EVENT REWRITE
	return 1

...
/datum/supply_packs/emergency/zedoutbreak
	name = "Zedkit Crate"
	contains = list(/obj/item/weapon/storage/firstaid/zed,
...
/datum/supply_packs/security/advtaser
	name = "Hybrid Taser crate"
	contains = list(/obj/item/weapon/gun/energy/taser/adv,
...
/datum/supply_packs/organic/alpaca
	name = "Alpaca Crate"
	cost = 30
	containertype = /obj/structure/closet/critter/alpaca
	containername = "alpaca crate"

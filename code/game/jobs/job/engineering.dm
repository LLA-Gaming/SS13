...
/datum/job/chief_engineer
	...
	departments = list("Command","Engineering")
	faction = "Station"
	total_positions = 1
	spawn_positions = 1
	...
	default_tablet = /obj/item/device/tablet/ce
...
/datum/job/chief_engineer/equip_items(var/mob/living/carbon/human/H, visualsOnly = FALSE)
...
/datum/job/engineer
	...
	default_tablet = /obj/item/device/tablet/engineer
	default_tablet_slot = slot_l_store
...
/datum/job/engineer/equip_items(var/mob/living/carbon/human/H, visualsOnly = FALSE)
...
/datum/job/atmos
	...
	default_tablet = /obj/item/device/tablet/atmos
	default_tablet_slot = slot_l_store
	default_headset = /obj/item/device/radio/headset/headset_eng
	default_storagebox = /obj/item/weapon/storage/box/engineer
...
/datum/job/atmos/equip_items(var/mob/living/carbon/human/H, visualsOnly = FALSE)

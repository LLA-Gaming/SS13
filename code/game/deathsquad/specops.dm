...
/client/proc/create_death_commando(obj/spawn_location, leader_selected = 0)
	...
	A.real_name = "[!leader_selected ? commando_rank : commando_leader_rank] [commando_name]"
...
/*
//INSERT CAMERAS INTO DEATHSQUAD

	var/obj/machinery/camera/I = new(src)
	I.c_tag = "[real_name]"
	I.network = list("deathsquad")
	I.name = "implanted security camera"
	I.desc = "It's used to monitor people."
	equip_to_slot_or_del(I, slot_r_hand) // it ends up in -you- anyway, not in your hand

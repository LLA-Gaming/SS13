...
/obj/machinery/detector/attack_hand(mob/user as mob)
	...
	if(src.allowed(user))
		...
		if(idmode == 0)
			dat += "Identification Scan: <A href='?src=\ref[src];idmode=1'>Is Off</A><BR><BR>"
		else
			dat += "Identification Scan: <A href='?src=\ref[src];idmode=1'>Is On</A><BR><BR>"


		if(scanmode == 0)
			dat += "Intrusive Scan: <A href='?src=\ref[src];scanmode=1'>Is Off</A><BR><BR>"
		else
			dat += "Intrusive Scan: <A href='?src=\ref[src];scanmode=1'>Is On</A><BR><BR>"



		if(senset == 0)
			dat += "Weapon Scan: <A href='?src=\ref[src];senmode=1'>Is Off</A><BR><BR>"
		else
			dat += "Weapon Scan: <A href='?src=\ref[src];senmode=1'>Is On</A><BR><BR>"
...
/obj/machinery/detector/proc/flash()
	...
	for (var/mob/O in viewers(src, null))
		...
		if (dudesthreat >= 4)
			...
			if(maxthreat < 2)
				playsound(loc, 'sound/machines/alert.ogg', 100, 1)
				maxthreat = 2
			...
			if(maxthreat < 1)
				playsound(loc, 'sound/machines/domore.ogg', 100, 1)
				maxthreat = 1
			...
			if(maxthreat == 0)
				playsound(loc, 'sound/machines/info.ogg', 100, 1)
...
/obj/machinery/detector/attackby(var/obj/item/O as obj, var/mob/user as mob)

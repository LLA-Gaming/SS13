...
/datum/game_mode/traitor
	...
	restricted_jobs = list("Cyborg", "Perseus Security Enforcer", "Perseus Security Commander")//They are part of the AI if he is traitor so are they, they use to get double chances

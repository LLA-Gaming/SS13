...
/obj/item/device/thinktronic_parts/core/hop/New()
	...
	new /obj/item/device/thinktronic_parts/program/cargo/cargobay{favorite = 2 alerts = 1}(src)
	new /obj/item/device/thinktronic_parts/program/general/notekeeper{favorite = 1}(src)
	new /obj/item/device/thinktronic_parts/program/general/crewmanifest{favorite = 1}(src)
	new /obj/item/device/thinktronic_parts/program/general/setstatus{favorite = 1}(src)
...
/obj/item/device/thinktronic_parts/core/medlaptop/New()
	...
	new /obj/item/device/thinktronic_parts/program/medical/crewmonitor{favorite = 1 alerts = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/notekeeper{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/medical/medrecords{favorite = 1 deletable = 0}(src)
...
/obj/item/device/thinktronic_parts/core/englaptop/New()
	...
	new /obj/item/device/thinktronic_parts/program/eng/enginebuddy{favorite = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/notekeeper{favorite = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/crewmanifest{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/setstatus{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/eng/powermonitor{favorite = 1 deletable = 0}(src)

/obj/item/device/thinktronic_parts/core/scilaptop/New()
	..()
	new /obj/item/device/thinktronic_parts/program/sci/researchmonitor{favorite = 1 alerts = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/sci/borgmonitor{favorite = 1 alerts = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/taskmanager/science/pro{favorite = 1 alerts = 1 DRM = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/crewmanifest{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/setstatus{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/signaller{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/notekeeper{favorite = 1 deletable = 0}(src)

/obj/item/device/thinktronic_parts/core/cargolaptop/New()
	..()
	new /obj/item/device/thinktronic_parts/program/cargo/mule_control{favorite = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/taskmanager/cargo/pro{favorite = 1 alerts = 1 DRM = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/cargo/cargobay{favorite = 1 alerts = 1 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/taskmanager{favorite = 2 deletable = 0}(src)
	new /obj/item/device/thinktronic_parts/program/general/notekeeper{favorite = 2 deletable = 0}(src)

/obj/item/device/thinktronic_parts/program/cargo/mule_control
	name = "Delivery Bot Control"
	var/obj/item/tabletradio/integrated/radio = null

	New()
		..()
		radio = new /obj/item/tabletradio/integrated/mule(src)

	use_app() //Put all the HTML here

		var/obj/item/tabletradio/integrated/mule/QC = radio
		if(!QC)

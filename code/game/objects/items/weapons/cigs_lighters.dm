...
/obj/item/weapon/reagent_containers/spacebong/attack_self(mob/user) //clear contents
	src.reagents.clear_reagents()
	update_icon()
	user << "<span class='notice'>You dump out the [src.name] onto the floor.</span>"
	return

/obj/item/weapon/reagent_containers/spacebong/afterattack(obj/target, mob/user, proximity) //Prevents using the bong as a ghetto grinder.

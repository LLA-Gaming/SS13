...
/obj/item/part/computer/cardslot
	...
	var/obj/item/weapon/card/id/writer	= null	// so that you don't need to typecast dual cardslots, but pretend it's not here
	...
	proc/insert(var/obj/item/weapon/card/id/card)
		if(!computer)
			return 0
		if(reader != null)
...
/obj/item/part/computer/cardslot/dual
	...
	dualslot = 1
	icon_state = "cardslot2"

	insert(var/obj/item/weapon/card/id/card,var/slot = 0)
		if(!computer)
			return 0
	...
	remove(var/obj/item/weapon/card/id/card)

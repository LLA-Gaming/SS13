...
/obj/machinery/computer3/security/wooden_tv
	name				= "Security TV"
	desc				= "An old TV hooked into the outpost's camera network. It's a wonder how it was made without exploding into a dozen bits and pieces."
...
/obj/machinery/computer3/security/mining
	name = "Mining CamView"
	desc = "Used to access the various cameras in the Mining Outpost."
...
/obj/machinery/computer3/wall_comp/telescreen/entertainment
	desc = "Damn, they better have tg-channel on these things."
...
/datum/file/camnet_key
	...
	var/title = "Station"
	var/desc = "Connects to outpost security cameras."

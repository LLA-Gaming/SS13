...
/obj/machinery/computer3/testing
	spawn_files =	list(/datum/file/program/aifixer,/datum/file/program/arcade,
						/datum/file/program/security,/datum/file/program/card_comp,
						/datum/file/program/borg_control, /datum/file/program/communications,
						/datum/file/program/crew,/datum/file/program/op_monitor,

						/datum/file/camnet_key,/datum/file/camnet_key/mining,/datum/file/camnet_key/entertainment,/datum/file/camnet_key/research,
						/datum/file/camnet_key/bombrange,/datum/file/camnet_key/xeno,/datum/file/camnet_key/prison)
...
/obj/machinery/computer3/wall_comp/testing
	spawn_files =	list(/datum/file/program/aifixer,/datum/file/program/arcade,/datum/file/program/security,/datum/file/program/card_comp,
						/datum/file/program/borg_control, /datum/file/program/communications,
						/datum/file/program/crew,/datum/file/program/op_monitor,
